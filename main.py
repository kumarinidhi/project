...
question = "Do u want to continue as " + spy_salutation +" " + spy_name + "Y/N : "
...
if existing == 'Y' or existing == 'y' :
    ...
    if len(spy_name) > 0:
        ...
        if spy_age > 12 and spy_age < 60:
            ...
            spy_is_online = True
            print "Authentication Completed. Welcome" + spy_name + "age:" + str(spy_age) + "and rating of: " + str(
                spy_rating) + "proud to have you."
